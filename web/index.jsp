<%-- 
    Document   : index
    Created on : 19 juil. 2022, 17:51:35
    Author     : Samir
--%>
  ...
  <body>
    ...
    <fmt:bundle basename="i18n.Bundle">
      <nav class="navbar">
        ...
        <div class="brand-title"><a href="Home"><i class="fa-solid fa-building-columns"></i> <label> ${BankName} </label></a></div>
      ...
      <div class="login-form-container">
        ...
        <form action="Login" method="post">
          ...
          <table>
            ...
            <tr>
              <td><a href=""><fmt:message key="ancher.forgot_password"/></a></td>
            </tr>
          </table>
