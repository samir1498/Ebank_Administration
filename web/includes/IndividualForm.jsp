...
<form class="individual-form" action="IndividualRegistration" method="post" enctype="multipart/form-data">
  ...
  <table>
    ...
    <tr>
      <td><label for="IDType"><fmt:message key="label.idtype"/></label></td>
      <td><select id="IDType" name="ID_type" required>
          <option value=""><fmt:message key="option.selectidtype"/></option>
          <option value="ID"><fmt:message key="option.id"/></option>
          <option value="Driver's license"><fmt:message key="option.driverlicense"/></option>
          <option value="Passport"><fmt:message key="option.passport"/></option>

        </select></td>
    </tr>

    <tr>
      <td><label for="idNumber"><fmt:message key="label.idnumber"/></label></td>
      <td><input id="idNumber" type="number" name="idNumber" required /></td>
    </tr>
